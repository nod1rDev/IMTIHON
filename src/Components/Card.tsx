...
function Card({
  ...
  return (
    <div onClick={onclick} className="bg-[#FFFFFF] rounded-lg shadow-[0px_10px_10px_-10px_#48549F1A] cursor-pointer dark:bg-[#1E2139] md:w-[672px] lg:w-[730px]  md:rounded-xl hover:border-[1px] hover:border-[#7C5DFA] dark:shadow-[0px_10px_10px_-10px_#48549F1A] px-4 py-5   flex justify-between  items-center ">
      <div className="flex flex-col md:items-center md:flex-row  md:gap-8 ">
        <span className="font-bold text-[15px]  mb-5 md:mb-0 leading-[15px] tracking-[-0.25px]">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between md:w-[60vh]  gap-1">
          ...
          <span className="font-bold text-[15px]  leading-[24px] tracking-[-0.25px]">
            £ {total}
          </span>
        </div>
      </div>
