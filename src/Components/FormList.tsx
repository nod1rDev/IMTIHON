...
export default function FormList() {
  ...
  return (
    <>
      ...
      {error ? (
        <div className=" absolute top-20 right-2 md:top-24 md:right-3 lg:top-10 lg:right-6">
          <Alert severity="error" onClose={() => setError(false)}>
            Uncorrectly complated invoice form!
          </Alert>
        </div>
      ) : (
        ""
      ...
      <dialog
        id="formModal"
        className="modal  backdrop:z-10 backdrop:mt-[72px] lg:backdrop:mt-0   md:backdrop:mt-[80px] lg:backdrop:ml-[103px]    bg-inherit"
      >
        <div className="modal-box px-0 py-0 bg-[#FFFFFF]  md:overflow-y-scroll overflow-x-hidden md:px-[20px]   min-w-full absolute top-[72px] lg:px-[30px] left-0  z-10 lg:top-0 rounded-none  md:min-w-[80%] lg:min-w-[616px] min-h-full rounded-tl-[-50px]    lg:left-[103px] md:left-0 md:top-[80px] dark:bg-[#141625]">
          <div className="flex flex-col pt-6 px-4">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-8">
              ...
              <div className="h-[40px] md:h-[70px] lg:h-[0px] w-full bg-inherit"></div>
            </form>
          </div>
        </div>
      </dialog>
