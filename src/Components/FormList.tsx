...
export default function FormList() {
  ...
  return (
    <>
      ...
      >
        <div className="modal-box px-0 py-0 bg-[#FFFFFF]  overflow-y-auto md:px-[20px]   min-w-full absolute top-[72px] lg:px-[30px] left-0  z-10 lg:top-0 rounded-none  md:min-w-[80%] lg:min-w-[616px] min-h-full rounded-tl-[-50px]    lg:left-[103px] md:left-0 md:top-[80px] dark:bg-[#141625]">
